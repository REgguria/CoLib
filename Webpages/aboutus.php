    ...
    <main class="container-fluid bg-secondary vh-100">
        <div class="container-fluid">
            <div class="container-fluid d-flex justify-content-center align-items-center">
                <div class="card m-5" style="width: 24em">
                    <img src="../Images/kamilphoto.jpg" class="card-img-top img-fluid" style="max-height: 20em;"/>
                    <div class="card-body">
                ...
                <div class="card m-5" style="width: 24em">
                    <img src="../Images/AAAAAAAA.png" class="card-img-top img-fluid" style="max-height: 20em;"/>
                    <div class="card-body">
